...
def signin():
    ...
    if username in r.keys() and password==r[username]:
        ...
        tab_control.add(tab2, text='''Внешний источник 
        данных о погоде и климате''')
        ...
        button_2 = Button(tab2, text='Посмотреть погоду', font=('Calibry(Body)',15,'bold'), bg='#1ab5ef', fg='white', cursor='hand2', border=0, height=1, width=20, command=weather).place(x=5, y=10)
