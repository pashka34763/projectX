...
def getWeather():
    try:
        ...
        #weather
        api = 'https://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=bb5658eb114bc9b0cc188af7d88e91b3'
        ...
        t.config(text=(temp,'°'))
        c.config(text=(translator.translate(condition),'|', 'ОЩУЩАЕТСЯ', 'КАК:', temp, '°'))
